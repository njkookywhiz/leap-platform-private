...
class LeapTaskGitPullCommand extends LeapScheduledTaskCommand
{
    private $templating;
    private $gitService;
    ...
    {
        parent::configure();
        $this->setName("leap:task:git:pull")->setDescription("Git pull");
    ...
    public function getTaskDescription(ScheduledTask $task)
    {
        ...
        $desc = $this->templating->render("@LeapPanel/Administration/task_git_pull.html.twig", array(
            "username" => $username,
            "email" => $email
        ));
        return $desc;
